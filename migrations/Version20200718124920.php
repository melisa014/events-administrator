 ...
 */
final class Version20200718124920 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE document (id INT NOT NULL, type VARCHAR(255) NOT NULL, cost INT DEFAULT NULL, person VARCHAR(255) NOT NULL, event VARCHAR(255) NOT NULL, confirmed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('COMMENT ON COLUMN document.confirmed_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE equipment (id INT NOT NULL, timetable_item_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, cost INT DEFAULT 0 NOT NULL, confirmed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_D338D583930F1820 ON equipment (timetable_item_id)');
        $this->addSql('COMMENT ON COLUMN equipment.confirmed_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE location (id INT NOT NULL, person_id INT DEFAULT NULL, event_id INT DEFAULT NULL, address VARCHAR(255) NOT NULL, cost INT DEFAULT 0 NOT NULL, confirmed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('COMMENT ON COLUMN location.confirmed_at IS \'(DC2Type:datetime_immutable)\'');
        ...
        $this->addSql('CREATE TABLE nutrition (id INT NOT NULL, event_id INT DEFAULT NULL, persons_count INT DEFAULT NULL, cost INT DEFAULT 0 NOT NULL, confirmed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_B7C360F171F7E88B ON nutrition (event_id)');
        $this->addSql('COMMENT ON COLUMN nutrition.confirmed_at IS \'(DC2Type:datetime_immutable)\'');
        $this->addSql('CREATE TABLE part (id INT NOT NULL, event_id INT DEFAULT NULL, part_type VARCHAR(255) NOT NULL, part_id INT NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_490F70C671F7E88B ON part (event_id)');
        $this->addSql('CREATE TABLE person (id INT NOT NULL, first_name VARCHAR(255) NOT NULL, middle_name VARCHAR(255) DEFAULT NULL, last_name VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE transport (id INT NOT NULL, event_id INT DEFAULT NULL, cost INT DEFAULT 0 NOT NULL, type VARCHAR(255) DEFAULT NULL, confirmed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_66AB212E71F7E88B ON transport (event_id)');
        $this->addSql('COMMENT ON COLUMN transport.confirmed_at IS \'(DC2Type:datetime_immutable)\'');
